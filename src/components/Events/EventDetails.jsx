...
export default function EventDetails() {
  ...
  if (isError) {
    content = <div id="event-details-content" className='center'>
      <ErrorBlock title="Failed to fetch data" message={error.info?.message || 'Failed to fetch event data, try again later'} />
    </div>
  }
    ...
    {isDeleting && (
        <Modal onClose={handleStopDelete}>
          ...
          <div className='form-actions'>
            {isPendingDeletion && <p> Deleteing please wait</p>}
            {!isPendingDeletion && (
              <>
